...
class AgentClass:
  ...
  def set_up(self):
    ...
    root_agent = llm_agent.LlmAgent(
      ...
      description=(
          'An expert evolutionary optimization brain specifically designed to analyze BPB matrices and generate highly optimized Python Tensor mutations for the OpenAI Parameter Golf challenge.'
      ),
      sub_agents=[],
